...
#include "data_buffer_ccmd.h"
#include "get_time_host_request.h"
...
//for custom command data buffer
#define CCMD_DATA_BUFFER_BASE_ADDR				(TEMPORARY_SPARE_DATA_BUFFER_BASE_ADDR + AVAILABLE_TEMPORARY_DATA_BUFFER_ENTRY_COUNT * BYTES_PER_SPARE_REGION_OF_SLICE)
#define CCMD_SPARE_DATA_BUFFER_BASE_ADDR		(CCMD_DATA_BUFFER_BASE_ADDR + AVAILABLE_CCMD_DATA_BUFFER_ENTRY_COUNT * BYTES_PER_DATA_REGION_OF_SLICE)
#define RESERVED_DATA_BUFFER_BASE_ADDR 			(CCMD_SPARE_DATA_BUFFER_BASE_ADDR + AVAILABLE_CCMD_DATA_BUFFER_ENTRY_COUNT * BYTES_PER_SPARE_REGION_OF_SLICE)
...
#define CCMD_DATA_BUF_MAP_ADDR		 		(TEMPORARY_DATA_BUFFER_MAP_ADDR + sizeof(TEMPORARY_DATA_BUF_MAP))
#define CCMD_DATA_BUF_HASH_TABLE_ADDR		(CCMD_DATA_BUF_MAP_ADDR + sizeof(CCMD_DATA_BUF_MAP))
// for map tables
#define LOGICAL_SLICE_MAP_ADDR				(CCMD_DATA_BUF_HASH_TABLE_ADDR + sizeof(CCMD_DATA_BUF_HASH_TABLE))
...
#define HOST_REQUEST_TIME_TABLE_ADDR		(CUSTOM_IO_CMD_COMPLETE_TABLE_ADDR + sizeof(CUSTOM_IO_CMD_COMPLETE_TABLE))
#define PRINT_BUFFER_TABLE_ADDR 			(HOST_REQUEST_TIME_TABLE_ADDR + sizeof(HOST_REQUEST_TIME_TABLE))

#define FTL_MANAGEMENT_END_ADDR				((PRINT_BUFFER_TABLE_ADDR + sizeof(PRINT_BUFFER_TABLE))- 1)
