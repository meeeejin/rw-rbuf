...
#ifdef RW_CMD
# define os_rw_io(type, mode, name_w, file_w, buf_w, offset_w, n_w,				\
    name_r, file_r, buf_r, offset_r, n_r)     \
	pfs_os_rw_io_func(type, mode, name_w, file_w, buf_w, offset_w, n_w,		\
    name_r, file_r, buf_r, offset_r, n_r, __FILE__, __LINE__)
#endif /* RW_CMD */
